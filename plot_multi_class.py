...
plt.savefig(RESULT_PATH+ "/F1_low_training_sample_regime_multi_class_classification.jpg", format='jpg', dpi=300)
plt.show()
...
plt.savefig(RESULT_PATH+ "/standard_deviation_low_training_sample_regime_multi_class_classification.jpg", format='jpg', dpi=300)
plt.show()
