"""
The program to plot the f1-score vs num of training samples per class for binary classification problem.
...
plt.savefig(RESULT_PATH+ "/F1_low_training_sample_regime_binary_classification.jpg", format='jpg', dpi=200)
plt.show()
...
plt.savefig(RESULT_PATH+ "/standard_deviation_low_training_sample_regime_binary_classification.jpg", format='jpg', dpi=200)
plt.show()
