...
3. unzip PREPROCESSED_DATA.7z (larger binary classificaton data). The dataset can be downloaded from [here](https://drive.google.com/drive/folders/1ysvHLL879iHvoV5YX1Gj7UkRm6jbQ3WR?usp=sharing). Accession IDs for all sequences as well as acknowledgement as provided in the folder titled: sequence_usage_acknowledgements.
